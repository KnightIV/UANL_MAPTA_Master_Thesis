...
calcular la magnitud diferencial de \atoObjId con la \quoteequation{observaciones:fotometriadiferencial:magdiferencialec}. Una gran ventaja de
...
de observación se encuentra en la \quotefigure{differentialMagDec7}, donde se
...
\quotefigure{iturbideAtoLightCurve}. El código completo se encuentra en
\href{https://github.com/KnightIV/UANL_MAPTA_Observaciones/blob/main/analisis/iturbide/iraf/qphot_sigma_clip.ipynb}{\code{qphot\_sigma\_clip.ipynb}}.
