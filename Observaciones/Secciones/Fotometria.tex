...
% TODO: confirma con Dr. Andrés si los problemas ya han sido resueltos
...
\reffigure{figuraCurvaLuzInstrumentalReferencia}. Por último, la curva de luz de
...
\reffigure{figuraIturbideAtoLightCurve}. Las imágenes calibradas se encuentran
...
\begin{figure}[!ht]
	\centering
	\xincludegraphics[scale=0.38, label=\textbf{(a)}, labelbox=true, pos=nw, fontsize=\large]{Observaciones/Secciones/Figures/Full LC.png}
	\xincludegraphics[scale=0.3, label=\textbf{(b)}, labelbox=true, pos=nw, fontsize=\large]{Observaciones/Secciones/Figures/Hour Sync LC.png}
