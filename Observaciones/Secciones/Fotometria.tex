...
\quotetable{observationSchedules}. Durante varias de estas noches de observación
...
calcular la magnitud diferencial de \atoObjId con la ecuación
\ref{observaciones:fotometriadiferencial:magdiferencialec}. Una gran ventaja de
...
de observación se encuentra en la figura \ref{differentialMagDec7}, donde se
...
\quotefigure{iturbideAtoLightCurve}. El código completo se encuentra en \href{https://github.com/KnightIV/UANL_MAPTA_Observaciones/blob/main/analisis/iturbide/iraf/qphot_sigma_clip.ipynb}{\code{qphot\_sigma\_clip.ipynb}}.
...
\begin{figure}[!ht] 
	\includegraphics[scale=0.55]{Observaciones/Secciones/Figures/Differential Magnitude 12-07.png}
...
\begin{figure}[!ht]
	\xincludegraphics[scale=0.44, label=\textbf{a)}, labelbox=true, pos=nw, fontsize=\large]{Observaciones/Secciones/Figures/Full LC.png}
	\xincludegraphics[scale=0.45, label=\textbf{b)}, labelbox=true, pos=nw, fontsize=\large]{Observaciones/Secciones/Figures/Hour Sync LC.png}
