...
datos de Gaia. Tal como es descrito en la \refthesissection{muestra:sec:gaia} la
...
documentación de Gaia DR3 \citeyearparen{gdr3ReleaseDocumentation}, como se puede
...
\citeyearparen{szkody2002CvSearchSdss}. Sin embargo, solo dos de los 4 indices de color
...
\begin{figure}[!ht]
	...
	\caption{Relación empírica entre las magnitudes reportadas en GDR3 y SDSS12. Las relaciones están dadas para 3 de las 5 bandas de SDSS12, debido a las diferencias entre las pasa bandas de Gaia y SDSS. \citeyearparen{gdr3ReleaseDocumentation}}
...
\citeyearparen{simbadDatabase} para restringir los objetos de interés a un tamaño
