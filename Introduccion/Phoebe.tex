...
no-lineales a cambio de una baja eficiencia computacional. En total, la cantidad
...
\citetbookchapter{phoebeScientificReference}{6.4}. En el ajuste de un sistema
...
\begin{figure}[!ht]
	...
	\begin{lstlisting}[language=Python, autogobble]
	# b: phoebe.Bundle
	b.add_solver('optimizer.nelder_mead', solver='opt_nm',
		fit_parameters=['teffratio', 'period@binary', 't0_supconj@binary', 'incl@binary', 'fillout_factor'],
		maxiter=50)
