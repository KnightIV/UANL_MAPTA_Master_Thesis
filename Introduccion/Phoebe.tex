...
% TODO: maybe remove, present only for formatting
\newpage
...
% TODO: maybe delete, only here for formatting
\newpage
...
\citeyearparen{foreman-mackey_emcee_2013} describe el proceso a mayor detalle,
...
el cual se especifica las características del ensamble. Esto se puede ver en la \refcode{codigoMuestreoMCMC}.
...
\begin{figure}[!ht]
	\centering
	\xincludegraphics[scale=0.35, label=\textbf{(a)}, labelbox=true, pos=ne, fontsize=\Large]{Introduccion/Figures/Figura PHOEBE Priors Gaussian.png}
	\xincludegraphics[scale=0.35, label=\textbf{(b)}, labelbox=true, pos=ne, fontsize=\Large]{Introduccion/Figures/Figura PHOEBE Priors Uniform.png}
