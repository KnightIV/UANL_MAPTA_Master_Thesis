...
\subsubsection{Atmósfera de Kurucz}
...
\citetbookchapter{phoebeScientificReference}{4.2}; para una discusión completa
del programa es necesario hacer referencia a \citet{kurucz_atlas_1970}.
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.35]{Introduccion/Figures/Figura Kurucz_PHOEBE Reference.png}
	\caption{Espectros sintéticos de las tablas de Kurucz para estrellas de varias temperaturas. El resto de los parámetros físicos utilizados se mantuvieron fijos para los cuatro modelos: $\log{g/g_0} = 4.0$ y [M/H] = 0.0. Figura obtenida de \citetbookchapter{phoebeScientificReference}{4.2}.}
...
\begin{figure}[!ht]
	\centering
	\includegraphics[scale=0.47]{Introduccion/Figures/Figura Evolucion_MS_Astronomy_Physical_Perspective.png}
