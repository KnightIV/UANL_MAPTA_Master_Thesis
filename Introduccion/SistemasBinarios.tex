...
\chapter{Sistemas Binarios} \label{capituloSistemasBinarios}
...
transformación descrita por \citetbooksection{phoebeScientificReference}{3.1}.
...
El potencial efectivo en la \refequation{ecuacionPotencialEfectivoFinal} se
...
\citetbookchapter{kopal_close_binary_systems_1959}{III.1}. Este potencial se
...
\begin{description}
	...
	de la escala de tiempo hidrostática, la cual, por ejemplo, es de
	\textapproxtilde 15 minutos para una estrella tipo solar
	(\citetbooksection{kallrath_eclipsing_binary_modelling_2009}{3.1.5}).
	Mientras la escala de tiempo de estas distorsiones sea despreciable con
	respecto al periodo orbital la superficie estelar (su fotósfera) se puede
	parametrizar con el modelo de Roche.
...
(\textcites{ding_fast_derivation_cbs_params_2022,michel_photometric_study_contact_binary_2023,michel_rotse1_new_wuma_eclipsing_binary_2016}),
las cuales al ser más frías que el resto de la superficie llega a manifestar
como una menor cantidad de radiación emitida por el sistema en ciertas fases.
Esto se atribuye a la actividad magnética de la estrella, y se utiliza
principalmente al momento de ajustar un modelo computacional a la curva de luz
observada.
