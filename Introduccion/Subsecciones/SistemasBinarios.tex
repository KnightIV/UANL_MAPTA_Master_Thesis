...
Las \textit{binarias espectroscópicas} presentan variaciones periódicas en sus espectros, en donde las líneas espectrales detectadas \quotes{oscilan periodicamente alrededor de la longitud de onda promedio} \citet{astronomyPhysicalPerspective::chapter5_binaryStars}. Esto se observa debido al \textbf{desplazamiento de Doppler}. 
