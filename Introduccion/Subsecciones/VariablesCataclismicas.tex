...
\input{Introduccion/Subsecciones/CV/Evolucion.tex}
\input{Introduccion/Subsecciones/CV/Componentes.tex}
...
componentes. \autocite{disentanglingGaiaHR} No siempre ocurre algún tipo de
...
\begin{figure}
	...
	\caption{Diagrama de una estrella enana blanca absorbiendo material de su
		...
		lóbulos de Roche.} \autocite{smithReview}
...
\autocite{smithReview} Aparte de la radiación generada debido a reacciones
