...
\usepackage[colorlinks,linkcolor=MyGray,urlcolor=blue,citecolor=blue]{hyperref}
\usepackage{natbib}
...
This research made use of Astropy,\footnote{\url{http://www.astropy.org}} a community-developed core Python package for Astronomy \citet*{astropy}.
\clearpage
