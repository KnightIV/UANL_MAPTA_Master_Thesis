...
\newcommand{\citeyearparen}[1]{\Citeauthor{#1} (\cite*{#1})}
\newcommand{\citetbookchapter}[2]{\Citeauthor{#1} (\cite*[\textcolor{MyLightBlue}{Capítulo #2}]{#1})}
\newcommand{\citetbooksection}[2]{\Citeauthor{#1} (\cite*[\textcolor{MyLightBlue}{Sección #2}]{#1})}
...
\definecolor{ChapterBlue}{rgb}{0.16,0.32,0.75}
...
\newcommand{\refthesischapter}[1]{{\color{ChapterBlue}\textbf{Capítulo \ref{#1}}}}
