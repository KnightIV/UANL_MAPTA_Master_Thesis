...
fotométrica} del sistema, en cual se reportan los valores óptimos de cada
...
estimadores adicionales, solo se puede aplicar el estimador \textbf{EBAI-KNN};
...
Una vez que se hayan determinado las distribuciones priores a utilizar para
...
PHOEBE ofrece la habilidad de ver el camino trazado por cada caminador
...
un muestreo ineficiente. Esto es una consecuencia de haber escogido una
distribución prior uniforme no informativa para el muestreo. El caso ideal
hubiera sido que esta solución se haya encontrado en el proceso de optimización;
...
primer reinicio el muestreo tenía una fracción de pasos aceptados promedio de
$0.196$, con el 43.12\% de los caminadores ostentando una fracción de pasos
aceptados entre 0.2 y 0.5. 
